...
public class eeTempRelCls3 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eeTempRelCls3(true);
  }
  ...
  public static eeTempRelCls3 instance;

  public static eeTempRelCls3 getInstance()
  {
    loadInstance();
    return instance;
  }

  private eeTempRelCls3(boolean b)
  {
    ...
    setExtractor(new eeTempRelCls3$$1());
    isClone = false;
  }
  ...
  public eeTempRelCls3()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls3");
    isClone = true;
  }

  public eeTempRelCls3(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eeTempRelCls3(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eeTempRelCls3.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eeTempRelCls3.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eeTempRelCls3.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
      name = "eeTempRelCls3";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_EE || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'eeTempRelCls3(TemporalRelation_EE)' defined on line 192 of eeTempRelCls.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls3 \\");
    ...
    eeTempRelCls3 classifier = new eeTempRelCls3();
  ...
  public int hashCode() { return "eeTempRelCls3".hashCode(); }
  public boolean equals(Object o) { return o instanceof eeTempRelCls3; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eeTempRelCls3(false).getParameters()); }
  }
}
