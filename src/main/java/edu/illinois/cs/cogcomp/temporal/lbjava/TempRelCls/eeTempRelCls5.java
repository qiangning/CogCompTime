...
public class eeTempRelCls5 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eeTempRelCls5(true);
  }
  ...
  public static eeTempRelCls5 instance;

  public static eeTempRelCls5 getInstance()
  {
    loadInstance();
    return instance;
  }

  private eeTempRelCls5(boolean b)
  {
    ...
    setExtractor(new eeTempRelCls5$$1());
    isClone = false;
  }
  ...
  public eeTempRelCls5()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls5");
    isClone = true;
  }

  public eeTempRelCls5(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eeTempRelCls5(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eeTempRelCls5.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eeTempRelCls5.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eeTempRelCls5.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
      name = "eeTempRelCls5";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_EE || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'eeTempRelCls5(TemporalRelation_EE)' defined on line 206 of eeTempRelCls.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls5 \\");
    ...
    eeTempRelCls5 classifier = new eeTempRelCls5();
  ...
  public int hashCode() { return "eeTempRelCls5".hashCode(); }
  public boolean equals(Object o) { return o instanceof eeTempRelCls5; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eeTempRelCls5(false).getParameters()); }
  }
}
