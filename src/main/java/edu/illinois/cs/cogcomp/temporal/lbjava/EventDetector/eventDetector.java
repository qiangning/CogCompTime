...
public class eventDetector extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eventDetector(true);
  }
  ...
  public static eventDetector instance;

  public static eventDetector getInstance()
  {
    loadInstance();
    return instance;
  }

  private eventDetector(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.EventDetectorPerceptronParams.learningRate, 0, ParamLBJ.EventDetectorPerceptronParams.thickness));
    containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.EventDetector";
    name = "eventDetector";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new eventDetector$$1());
    isClone = false;
  }
  ...
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.EventDetector.eventDetector");
    isClone = true;
  }

  public eventDetector(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eventDetector(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eventDetector.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eventDetector.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eventDetector.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.EventDetector";
      name = "eventDetector";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof EventTokenCandidate || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'eventDetector(EventTokenCandidate)' defined on line 227 of eventDetector.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof EventTokenCandidate[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof EventTokenCandidate || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.EventDetector.eventDetector \\");
    ...
    eventDetector classifier = new eventDetector();
  ...
  public int hashCode() { return "eventDetector".hashCode(); }
  public boolean equals(Object o) { return o instanceof eventDetector; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eventDetector(false).getParameters()); }
  }
}
