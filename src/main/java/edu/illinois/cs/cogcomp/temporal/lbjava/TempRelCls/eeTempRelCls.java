...
public class eeTempRelCls extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eeTempRelCls(true);
  }
  ...
  public static eeTempRelCls instance;

  public static eeTempRelCls getInstance()
  {
    loadInstance();
    return instance;
  }

  private eeTempRelCls(boolean b)
  {
    ...
    setExtractor(new eeTempRelCls$$1());
    isClone = false;
  }
  ...
  public eeTempRelCls()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls");
    isClone = true;
  }

  public eeTempRelCls(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eeTempRelCls(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eeTempRelCls.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eeTempRelCls.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eeTempRelCls.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
      name = "eeTempRelCls";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_EE || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'eeTempRelCls(TemporalRelation_EE)' defined on line 178 of eeTempRelCls.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls \\");
    ...
    eeTempRelCls classifier = new eeTempRelCls();
  ...
  public int hashCode() { return "eeTempRelCls".hashCode(); }
  public boolean equals(Object o) { return o instanceof eeTempRelCls; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eeTempRelCls(false).getParameters()); }
  }
}
