...
public class IOManager {
    ...
    // ====================
    public static List<String> listDirectoryByExtension(String dirPath,
    ...
    // =====================
    public static List<String> readLinesWithoutTrimming(String fileName) {
        BufferedReader reader = openReader(fileName);
        String line;
        ArrayList<String> content = new ArrayList<String>();
        try {
    ...
    public static void writeString(String line, BufferedWriter writer) {
        try {
            ...
            e.printStackTrace();
            System.out
                    .println("Unable to write to file. Function 'writeString' in IOManager!");
            System.exit(1);
        }
    }
