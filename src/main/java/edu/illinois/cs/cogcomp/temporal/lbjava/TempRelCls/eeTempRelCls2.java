...
public class eeTempRelCls2 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eeTempRelCls2(true);
  }
  ...
  public static eeTempRelCls2 instance;

  public static eeTempRelCls2 getInstance()
  {
    loadInstance();
    return instance;
  }

  private eeTempRelCls2(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.EETempRelClassifierPerceptronParams.learningRate, 0, ParamLBJ.EETempRelClassifierPerceptronParams.thickness));
    containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
    name = "eeTempRelCls2";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new eeTempRelCls2$$1());
    isClone = false;
  }
  ...
  public eeTempRelCls2()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls2");
    isClone = true;
  }

  public eeTempRelCls2(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eeTempRelCls2(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eeTempRelCls2.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eeTempRelCls2.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eeTempRelCls2.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
      name = "eeTempRelCls2";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_EE || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'eeTempRelCls2(TemporalRelation_EE)' defined on line 185 of eeTempRelCls.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof TemporalRelation_EE[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof TemporalRelation_EE || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls2 \\");
    ...
    eeTempRelCls2 classifier = new eeTempRelCls2();
  ...
  public int hashCode() { return "eeTempRelCls2".hashCode(); }
  public boolean equals(Object o) { return o instanceof eeTempRelCls2; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eeTempRelCls2(false).getParameters()); }
  }
}
