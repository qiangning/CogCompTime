...
public class etTempRelCls extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new etTempRelCls(true);
  }
  ...
  public static etTempRelCls instance;

  public static etTempRelCls getInstance()
  {
    loadInstance();
    return instance;
  }

  private etTempRelCls(boolean b)
  {
    super(new SparseAveragedPerceptron(ParamLBJ.ETTempRelClassifierPerceptronParams.learningRate, 0, ParamLBJ.ETTempRelClassifierPerceptronParams.thickness));
    containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls_ET";
    name = "etTempRelCls";
    setEncoding(null);
    setLabeler(new Label());
    setExtractor(new etTempRelCls$$1());
    isClone = false;
  }
  ...
  public etTempRelCls()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls_ET.etTempRelCls");
    isClone = true;
  }

  public etTempRelCls(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public etTempRelCls(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(etTempRelCls.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(etTempRelCls.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(etTempRelCls.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls_ET";
      name = "etTempRelCls";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_ET || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'etTempRelCls(TemporalRelation_ET)' defined on line 156 of etTempRelCls.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof TemporalRelation_ET[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof TemporalRelation_ET || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls_ET.etTempRelCls \\");
    ...
    etTempRelCls classifier = new etTempRelCls();
  ...
  public int hashCode() { return "etTempRelCls".hashCode(); }
  public boolean equals(Object o) { return o instanceof etTempRelCls; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new etTempRelCls(false).getParameters()); }
  }
}
