...
public class eeTempRelCls4 extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new eeTempRelCls4(true);
  }
  ...
  public static eeTempRelCls4 instance;

  public static eeTempRelCls4 getInstance()
  {
    loadInstance();
    return instance;
  }

  private eeTempRelCls4(boolean b)
  {
    ...
    setExtractor(new eeTempRelCls4$$1());
    isClone = false;
  }
  ...
  public eeTempRelCls4()
  {
    super("edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls4");
    isClone = true;
  }

  public eeTempRelCls4(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

  public eeTempRelCls4(Parameters p, String modelPath, String lexiconPath) {
    super(p);
    try {
    ...
    else if (IOUtilities.existsInClasspath(eeTempRelCls4.class, modelPath)) {
      System.out.println("Model file "+modelfile.getAbsolutePath()+" located in a jar file");
      readModel(IOUtilities.loadFromClasspath(eeTempRelCls4.class, modelPath));
      readLexiconOnDemand(IOUtilities.loadFromClasspath(eeTempRelCls4.class, lexiconPath));
    }
    else {
      containingPackage = "edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls";
      name = "eeTempRelCls4";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof TemporalRelation_EE || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'eeTempRelCls4(TemporalRelation_EE)' defined on line 199 of eeTempRelCls.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.temporal.lbjava.TempRelCls.eeTempRelCls4 \\");
    ...
    eeTempRelCls4 classifier = new eeTempRelCls4();
  ...
  public int hashCode() { return "eeTempRelCls4".hashCode(); }
  public boolean equals(Object o) { return o instanceof eeTempRelCls4; }
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new eeTempRelCls4(false).getParameters()); }
  }
}
